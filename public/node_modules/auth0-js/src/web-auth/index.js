...
import assert from 'auth0-js/src/helper/assert';
import error from 'auth0-js/src/helper/error';
import PluginHandler from 'auth0-js/src/helper/plugins';
import windowHelper from 'auth0-js/src/helper/window';
import objectHelper from 'auth0-js/src/helper/object';
import SSODataStorage from 'auth0-js/src/helper/ssodata';
...
import Redirect from 'auth0-js/src/web-auth/redirect';
import Popup from 'auth0-js/src/web-auth/popup';
import SilentAuthenticationHandler from 'auth0-js/src/web-auth/silent-authentication-handler';
import CrossOriginAuthentication from 'auth0-js/src/web-auth/cross-origin-authentication';
import WebMessageHandler from 'auth0-js/src/web-auth/web-message-handler';
import HostedPages from 'auth0-js/src/web-auth/hosted-pages';
